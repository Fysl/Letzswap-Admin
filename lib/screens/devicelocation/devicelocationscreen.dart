...
import 'package:letzswap_dashboard/models/devicelocationmodel/devicemodel.dart';
...
class DeviceLocationScreen extends StatefulWidget {
  const DeviceLocationScreen({ Key? key }) : super(key: key);
...
var newUrl=Uri.http(BASEURL.baseurl,"/api/Device/GetCoordinates",queryParameters);
   ...
   var model =DeviceModel.fromJson(res);
   ...
   print(data);
    ...
    //  var model= CategoryModel.fromJson(res);
      ...
      print("Device Location List Loaded");
     return model;


    } else {
         print("Error in Device Location List Loaded");
                          ...
                          rows: snapShot.data!.result.map<DataRow>((e) {
                            return DataRow(
                              cells: <DataCell>[
                                ...
                                DataCell(Text('${e.deviceinfo}')),
                                  DataCell(Text('${e.coordinates}')),
